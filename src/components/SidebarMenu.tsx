...
export const SidebarMenu: React.FC = () => {
  ...
  // Update `isCollapsed` based on screen size
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <aside
      className={classNames(
        "bg-base-200 text-base-content flex flex-col transition-all duration-300",
    ...
    >
      ...
      <div className="p-4 flex items-center justify-between">
        ...
        />
        {!isCollapsed && (
          <span className="ml-4 text-lg font-bold">John Doe</span>
        )}
        <button
          onClick={toggleCollapse}
...
const SidebarItem: React.FC<SidebarItemProps> = ({
  ...
  return (
    <Link
      to={pathTo}
      className="flex items-center p-2 rounded-lg hover:bg-base-300 transition-all"
    >
